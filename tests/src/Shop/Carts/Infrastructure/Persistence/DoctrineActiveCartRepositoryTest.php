...
use Techpump\Shop\Carts\Infrastructure\Persistence\DoctrineActiveCartRepository;
 ...
 * @group integration
 */
class DoctrineActiveCartRepositoryTest extends AppContextInfrastructureTestCase
{
    private DoctrineActiveCartRepository $repository;
    ...
    protected function setUp(): void
    {
        ...
        $this->repository = new DoctrineActiveCartRepository(entityManager: $entityManager);
    }
    ...
    {
        $this->assertInstanceOf(DoctrineActiveCartRepository::class, $this->repository);
